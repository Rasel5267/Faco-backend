...
var ValidatePassword = function (enteredPassword, savePassword, salt) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.GeneratePassword)(enteredPassword, salt)];
            case 1: return [2 /*return*/, (_a.sent()) === savePassword];
        }
    });
}); };
