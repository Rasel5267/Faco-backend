...
var CustomerSignup = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var customerInputs, inputErrors, email, phone, password, salt, userPassword, existCustomer, _a, otp, expiry, result, signature;
        ...
        switch (_b.label) {
            ...
            case 4:
                ...
                if (existCustomer !== null) {
                    return [2 /*return*/, res.status(400).json({ message: 'An user exist with this email ID' })];
                }
            ...
            case 5:
                ...
                return [4 /*yield*/, (0, utility_1.onRequestOTP)(otp, email)];
            case 6:
                // send the otp to customer
                _b.sent();
            ...
            case 7: return [2 /*return*/, res.json({ msg: "Fail to Signup" })];
        }
    });
}); };
...
var CustomerLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                customerInputs = (0, class_transformer_1.plainToClass)(dto_1.UserLoginInputs, req.body);
                return [4 /*yield*/, (0, class_validator_1.validate)(customerInputs, { validationError: { target: true } })];
            case 1:
            ...
            case 3:
                ...
                _a.label = 4;
            case 4: return [2 /*return*/, res.json({ msg: "Fail to SignIn" })];
        }
    });
}); };
