...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, ownerName, foodTypes, pinCode, address, phone, email, password, existVendor, salt, userPassword, CreateVendor;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                existVendor = _b.sent();
                if (existVendor !== null) {
                    return [2 /*return*/, res.json({ msg: "A vendor is exist with this email ID" })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ msg: "vendors data not available" })];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ msg: "vendor data not available" })];
        }
    });
}); };
